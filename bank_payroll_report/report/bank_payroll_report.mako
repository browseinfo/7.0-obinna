        			...
        			<table class="normal_table1" width="100%" height="100%">
				        ...
				        %for line in (get_total(o)):
						    <tr>
						    	...
						    	<td><b>N ${line.get('meal') or '0.00'}</b></td>
						    	<td><b>N ${line.get('rent') or '0.00'}</b></td>
						    	<td><b>N ${line.get('transport') or '0.00'}</b></td>
						    	<td><b>N ${line.get('furniture') or '0.00'}</b></td>
						    	<td><b>N ${line.get('domestic_servent') or '0.00'}</b></td>
						    	<td><b>N ${line.get('entertainment') or '0.00'}</b></td>
						    	<td><b>N ${line.get('accomodation') or '0.00'}</b></td>
						    	<td><b>N ${line.get('personal_alw') or '0.00'}</b></td>
						    	<td><b>N ${line.get('motor_allw') or '0.00'}</b></td>
						    	<td><b>N ${line.get('newspaper') or '0.00'}</b></td>
						    	<td><b>N ${line.get('utilities') or '0.00'}</b></td>
						    	<td><b>N ${line.get('leave_grant') or '0.00'}</b></td>
						    	<td><b>N ${line.get('peculiar') or '0.00'}</b></td>
						    	<td><b>N ${line.get('arrear_basic') or '0.00'}</b></td>
						    	<td><b>N ${line.get('under_payment') or '0.00'}</b></td>
