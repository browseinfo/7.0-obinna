...
class bank_payroll_consolidate_report(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(bank_payroll_consolidate_report, self).__init__(cr, uid, name, context)
    ...
    def set_context(self, objects, data, ids, report_type=None):
        ...
        return super(bank_payroll_consolidate_report, self).set_context(objects, data, ids, report_type=report_type)
    ...
    def _get_total(self, obj,):
        ...
        result = []
        basic = acting_allow = overtime = gross_amount = tax = nhf = other_ded = pension =nhis =ctls = mv_adv_interest = personl_adv = nigerin_reg = fghb = over_payment = salary_advance = deducation_amt = net_pay = peculiar=underpayment= arrear_basic = taxable = net_total = 0.0
...
report_sxw.report_sxw('report.bank.payroll.consolidate.report.all', 'hr.payslip', 'addons/bank_report/report/bank_payroll_consolidate_report.mako', parser=bank_payroll_consolidate_report, header=False)
