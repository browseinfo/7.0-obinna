...
class nhis_report(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(nhis_report, self).__init__(cr, uid, name, context)
        self.count = 0
    ...
    def set_context(self, objects, data, ids, report_type=None):
        ...
        return super(nhis_report, self).set_context(objects, data, ids, report_type=report_type)
...
report_sxw.report_sxw('report.nhis.date.webkit.report', 'hr.payslip', 'addons/nhis_webkit_report/report/nhis_report.mako', parser=nhis_report, header=False)
