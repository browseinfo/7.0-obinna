...
<body>
	...
	<table border=1 style="width:600px">
		<tr>
			<td>
				<table border=1 style="width:600px">
					...
					<tr>
						<td>Basic Salary </td>
						<td>${get_payslip_lines(o.line_ids)['basic']} </td>
					</tr>
					<tr>
						<td>Over Time </td>
					...
					<tr>
						<td>Arrears Basic</td>
						<td>${get_payslip_lines(o.line_ids)['arrear'] or '0.0'}</td>
					</tr>
					<tr class="noBorder">
						<td></td>
						<td></td>
					...
					<tr>
						<td><b>Total Basic Salary</b> </td>
						<td>${get_total_basic_salary(o)} </td>
					</tr>
					<tr class="noBorder">
						<td></td>
						<td></td>
					...
					<tr>
						<td>Housing </td>
						<td>${get_payslip_lines(o.line_ids)['housing'] or '0.0'} </td>
					</tr>
					<tr>
						<td>Transport </td>
						<td>${get_payslip_lines(o.line_ids)['transport'] or '0.0'}  </td>
					</tr>
					<tr>
						<td>Meal </td>
						<td>${get_payslip_lines(o.line_ids)['meal'] or '0.0'}  </td>
					</tr>
					<tr>
						<td>Utility</td>
						<td>${get_payslip_lines(o.line_ids)['utilities'] or '0.0'}  </td>
					</tr>
					<tr>
						<td>Accomodation </td>
						<td>${get_payslip_lines(o.line_ids)['accomodation'] or '0.0'}  </td>
					</tr>
					<tr>
						<td>Domestic Servants </td>
						<td>${get_payslip_lines(o.line_ids)['domestic'] or '0.0'}  </td>
					</tr>
					<tr>
						<td>Entertainment </td>
						<td>${get_payslip_lines(o.line_ids)['entertainment'] or '0.0'}  </td>
					</tr>
					<tr>
						<td>Personal Assistant </td>
						<td>${get_payslip_lines(o.line_ids)['personal_alw'] or '0.0'}  </td>
					</tr>
					<tr>
						<td>Motor Maintainance & Fueling </td>
						<td>${get_payslip_lines(o.line_ids)['motor_allw'] or '0.0'}  </td>
					</tr>
					<tr>
						<td>Newspaper </td>
						<td>${get_payslip_lines(o.line_ids)['newspaper'] or '0.0'}  </td>
					</tr>
					<tr>
						<td>Furniture </td>
						<td>${get_payslip_lines(o.line_ids)['furniture'] or '0.0'} </td>
					</tr>
					<tr>
						<td>Arrears </td>
						<td>${get_payslip_lines(o.line_ids)['arrear'] or '0.0'}  </td>
					...
					<tr>
						<td>Leave Grant </td>
						<td>${get_payslip_lines(o.line_ids)['leave'] or '0.0'}  </td>
					</tr>
					<tr>
					...
					<tr>
						<td>Under Payment </td>
						<td>${get_payslip_lines(o.line_ids)['under_payment'] or '0.0'}  </td>
					</tr>
				    <tr>
		...
		<td>
		<table border="1px" style="width:690px">
				  <tr>
