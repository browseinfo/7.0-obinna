...
class payslip_march_report(report_sxw.rml_parse):
    ...
    def get_payslip_lines(self, obj):
        ...
        if ids:
            ...
            emolument = wages['Basic'] #need to check EMOLUMENT and net total and other values are correct or not.
            ...
            under_payment = {'underpayment': under_payment_alw}
...
report_sxw.report_sxw('report.payslip.report.basic', 'hr.payslip',
                       'payslip_report/report/report_payslip_basic_consolidated.mako',
