...
class tax_report(report_sxw.rml_parse):
    ...
    def set_context(self, objects, data, ids, report_type=None):
        ...
        return super(tax_report, self).set_context(objects, data, ids, report_type=report_type)
...
report_sxw.report_sxw('report.tax.date.webkit.report', 'hr.payslip', 'addons/tax_webkit_report/report/tax_report.mako', parser=tax_report, header=False)
